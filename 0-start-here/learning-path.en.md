...
duration: 30min
tools: []
prerequisites: ["0-start-here/what-is-ai.en.md", "0-start-here/ai-anxiety.en.md"]
tags: [learning path, learning method, beginner]
...
**What is Fine-tuning**:
Training on specific data based on pre-trained models to adapt to specific tasks.
...
### Prerequisites
- [What is AI](./what-is-ai.en.md) - Understand AI's basic concepts
- [Why You Don't Need AI Anxiety](./ai-anxiety.en.md) - Build correct learning mindset

### Related Concepts
- [AI Tool Selection Matrix](../2-choose-tools/tool-matrix.en.md) - Choose tools that fit you
- [Prompt Technique Library](../prompts/) - Advanced prompt writing

### Deep Dive
- [Industry Application Cases](../roles/) - How different professions use AI
- [In-depth AI Understanding](../1-understand-ai/) - More detailed technical explanations
